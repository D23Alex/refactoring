...
Этап 3, и последний (Мы здесь). Больше разных игровых событий. Больше продвинутой статистики. Добавление кэширования для 2 сервиса. Больше алгоритмов кэширования для 3 сервиса. Рефакторинг кода. Решение всех тех проблем, что непременно должны возникнуть в ходе этапов 1 и 2, но о которых мы пока не знаем.
